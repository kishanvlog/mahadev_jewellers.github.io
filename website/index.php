...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/img1.jpg" alt="Shiv" width="1100" height="500">
      <div class="carousel-caption">
        <h3>Mahadev jewellers</h3>
        <p>We have great shop</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="image/img2.jpg" alt="Shankar" width="1100" height="500">
      <div class="carousel-caption">
        <h3>Mahadev jewellers</h3>
        <p>We have better staff</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="image/img3.jpg" alt="Rudra" width="1100" height="500">
      <div class="carousel-caption">
        <h3>Mahadev jewellers</h3>
        <p>We have brand new designs</p>
      </div>   
    </div>
  </div>
	...
	<div class="container-fluid">
		...
		<div class="row mb-5">
			<div class="col-lg-6 col-md-6 col-12">
				<img src="image/img4.jpg" class="img-fluid" height="500px" />
			</div>
			...
			<div class="col-lg-6 col-md-6 col-12">
				...
				<P>
					<h1>Kishan Soni...(Owner of the shop)</h1>
					City:palitana</br>
					Study:BCA complete
			...
			<div class="row text-center">
				...
				<div class="col-lg-4 col-md-4 col-12">
					<div class="card" >
						...
						<div class="card-body">
							<h4 class="card-title">Purchases item</h4>
				...
				<div class="col-lg-4 col-md-4 col-12">
					<div class="card" >
						<img class="card-img-top" src="image/img7.jpg" alt="Card image" />
						<div class="card-body">
							<h4 class="card-title">Other</h4>
							<p class="card-text">diamond or other jewellery</p>
							<a href="#" class="btn btn-primary">See Profile</a>
						</div>
					</div>
				</div>
...
<section class="bg-primary">
	<article class="py-4 text-center text-white">
		<div>
				<h3 class="display-4">+91 9558195865</h3>
			...
			<form action="/action_page.php">
  				<div class="form-group">
   					 <label for="email">Your Name</label>
  				  	 <input type="text" class="form-control" id="email" autocomplete="off" placeholder="Enter your name">
 				 </div>
  				<div class="form-group">
 			 ...
 			 <div class="form-group">
   					 <label for="email">Mobile</label>
  				  	 <input type="number" class="form-control" id="email" autocomplete="off" placeholder="Enter your mobile">
 			 </div>
 			 <div class="form-group">
 			 		<label>Address</label>
